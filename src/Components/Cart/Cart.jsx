...
export default function Cart() {
  ...
  return <>
    <h1 className=" text-center py-8 px-2 text-4xl  text-main  font-bold  bg-dark border-5 border-gray-600 rounded-lg shadow dark:bg-gray-1000 dark:border-gray-800">*CART*</h1>
