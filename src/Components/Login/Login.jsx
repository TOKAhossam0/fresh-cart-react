...
//*************************************************************************************** */
  ...
  return <>
    ...
    <h1 className="font-bold text-center text-4xl  py-9 text-fa-bold text-main">*LOGIN NOW*</h1>
    ...
    <form className="md:w-2/2 w-[80%] mx-auto my-10  " onSubmit={formik.handleSubmit}>
      ...
      <div className='md:flex items-center '>
        ...
        <Link to='/forgetpassword'><p className='py-2 md:py-0 text-2xl ms-4 font-bold text-main'>forget your password ?</p></Link>
      </div>
