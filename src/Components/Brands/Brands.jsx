...
export default function Brands() {
  ...
  return <>
    <div className='my-9'>
      <h1 className=" text-center text-main font-bold text-4xl bg-dark border-5 border-gray-600 rounded-lg shadow dark:bg-gray-1000 dark:border-gray-800">*BRANDS*</h1>
